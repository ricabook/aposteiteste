...
-- Atualizar função close_simple_bet para não usar valores negativos
...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      DECLARE
        remaining_to_close NUMERIC := _amount - closed_amount;
        remaining_bet NUMERIC := bet_record.amount - remaining_to_close;
      BEGIN
        -- Mark original bet as closed
        UPDATE bets 
